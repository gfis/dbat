...
<xsl:template match="iv:dbiv">
    ...
    <xsl:comment><!-- File header comment -->
        ...
        <xsl:value-of select="concat('&#32;&#x20;Generated by dbat/etc/xslt/dbiv_spec.xsl V1.4 on ', translate(substring(date:date-time(), 1, 19), 'T', ' '), '&#10;')" />
...
<xsl:template match="db:select|db:from|db:col|db:where|db:order|db:parm">
    <xsl:copy>
        <xsl:apply-templates select="@*|node()" />
    </xsl:copy>
    <xsl:value-of select='"&#10;&#32;&#x20;&#32;&#x20;&#32;&#x20;&#32;&#x20;"' />
                        ...
                        <xsl:choose>
                            ...
                            <xsl:when test="$field/@type = 'textarea'">
                                ...
                                -->
                                        ...
                                        -->
                                            <xsl:call-template name="replace">
                                                <xsl:with-param name="source" select="$field/@valid" />
