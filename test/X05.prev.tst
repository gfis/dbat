wget -q -O - "http://localhost:8080/dbat/servlet?spec=test/callproc"
...
<link rel="stylesheet" type="text/css" href="spec/test/stylesheet.css" />
    ...
    <form method="get" action="servlet?spec=test/callproc"><input name="spec" type="hidden" value="test/callproc" />
        ...
        Part: <input name="part" init="" value=""></input>
...
<br />Output on 2012-05-21 18:53:21.918 by <a href="index.html">Dbat</a> script <a target="_blank" href="spec/test/callproc.xml" type="text/plain">test/callproc</a>,
