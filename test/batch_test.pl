...
# Caution, must be encoded in UTF-8: äöüÄÖÜß
#------------------------------------------------------------------
#
...
# version control (e.g. svn, cvs), together with the testcase definitions in *.tca.
#
# Usage: 
#   perl batch_test.pl [-fill|-ref|-comp] [-only testnr] [<] file1 file2 ...
