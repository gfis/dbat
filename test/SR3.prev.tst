java -cp ../dist/dbat.jar org.teherba.dbat.Dbat -c ../etc/worddb.properties -e UTF-8 -f ../web/spec/test/color07.xml -p lang=en
...
<br />Output on yyyy-mm-dd hh:mm:ss by <a href="index.html">Dbat</a> script <a target="_blank" href="./../web/spec/test/color07.xml" type="text/plain">../web/spec/test/color07.xml</a>,
