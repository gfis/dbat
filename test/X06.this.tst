wget -q -O - "http://localhost:8080/dbat/servlet?spec=test/callproc&part=or"
...
<link rel="stylesheet" type="text/css" href="spec/test/stylesheet.css" />
    ...
    <form method="get" action="servlet?spec=test/callproc"><input name="spec" type="hidden" value="test/callproc" />
        ...
        Part: <input name="part" init="" value="or"></input>
...
<br />Output on 2012-06-01 22:56:10.246 by <a href="index.html">Dbat</a> script <a target="_blank" href="spec/test/callproc.xml" type="text/plain">test/callproc</a>,
