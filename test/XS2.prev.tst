...
-->
<dbat xmlns="http://www.teherba.org/2007/dbat" xmlns:ht="http://www.w3.org/1999/xhtml" xmlns:iv="http://www.teherba.org/2011/dbiv" xmlns:db="http://www.teherba.org/2007/dbat" conn="worddb" encoding="UTF-8" lang="en" title="test/crud02">
  <!--
...
<choose>
  ...
  <when name="view" match="dat">
    ...
    <ht:form name="form1" method="post">
      ...
      <ht:tr><ht:td valign="top" title="user">User:</ht:td>
        <ht:td><parm name="user"/>
        </ht:td></ht:tr>
      <ht:tr><ht:td valign="top" title="changed">Changed:</ht:td>
        <ht:td><parm name="changed"/>
        </ht:td></ht:tr>
      </ht:table>
...
<choose>
  <when name="view" match="(sear|ins2|upd2|del2|)">
    ...
    <select limit="2048">
      <col pseudo="image" label="Upd." align="center" remark="update" link="test/crud02&amp;search_name=&amp;search_family=&amp;search_gender=&amp;name=&amp;family=&amp;gender=&amp;view=">
      ...
      <col pseudo="image" label="Del." align="center" remark="delete" link="test/crud02&amp;search_name=&amp;search_family=&amp;search_gender=&amp;name=&amp;family=&amp;gender=&amp;view=">
        '<parm name="search_name"/>' || '=' 
         || '<parm name="search_family"/>' || '=' 
         || '<parm name="search_gender"/>' || '=' 
         || name || '=' 
