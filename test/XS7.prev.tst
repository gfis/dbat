...
<!--
    Interactive view definition for test form crud06.xml
    @(#) S/Id/S
    2014-03-04, Dr. Georg Fischer: copied from crud03.iv.xml
-->
<!--test/crud06.xml äöü
  Generated by dbat/etc/xslt/dbiv_spec.xsl V1.4 on yyyy-mm-dd hh:mm:ss
  DO NOT EDIT HERE, but in test/crud06.iv.xml instead!
-->
<dbat xmlns="http://www.teherba.org/2007/dbat" xmlns:ht="http://www.w3.org/1999/xhtml" xmlns:iv="http://www.teherba.org/2011/dbiv" xmlns:db="http://www.teherba.org/2007/dbat" encoding="UTF-8" conn="worddb" lang="en" title="test/crud06">
  <!--
  ...
  <ht:h2><ht:a href="servlet?spec=test.index">Test</ht:a> Form - Relatives (not all fields editable)</ht:h2>
<choose>
  ...
  <when name="view" match="del">
    ...
    <ht:form method="post">
      ...
      <ht:input type="submit" value="Delete"/> <ht:a href="servlet?spec=test/crud06">Back</ht:a> to the search form
    </ht:form>
  </when><!--== d e l 2 ==============-->
  ...
  <when name="view" match="dat">
    ...
    <ht:form name="form1" method="post">
      ...
      <ht:a href="servlet?spec=test/crud06">Back</ht:a> to the search form
    </ht:form>
  </when><!--== i n s ==============-->
  <when name="view" match="ins">
    ...
    <ht:form name="form1" method="post">
      ...
      <ht:input type="submit" value="Save"/> <ht:a href="servlet?spec=test/crud06">Back</ht:a> to the search form
    </ht:form>
  </when><!--== i n s 2 ==============-->
  ...
  <when name="view" match="upd">
    ...
    <ht:form name="form1" method="post">
      ...
      <ht:input type="submit" value="Update"/> <ht:a href="servlet?spec=test/crud06">Back</ht:a> to the search form
    </ht:form>
  </when><!--== u p d 2 ==============-->
...
<choose>
  <when name="view" match="(sear|ins2|upd2|del2|)">
    ...
    <select limit="2048">
      <col pseudo="image" label="Upd." align="center" remark="update" link="test/crud06&amp;search_name=&amp;search_family=&amp;search_gender=&amp;name=&amp;family=&amp;gender=&amp;view=">
      ...
      <col pseudo="image" label="Del." align="center" remark="delete" link="test/crud06&amp;search_name=&amp;search_family=&amp;search_gender=&amp;name=&amp;family=&amp;gender=&amp;view=">
        '<parm name="search_name"/>' || '=' 
         || '<parm name="search_family"/>' || '=' 
         || '<parm name="search_gender"/>' || '=' 
         || name || '=' 
