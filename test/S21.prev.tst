java -cp ../dist/dbat.jar org.teherba.dbat.Dbat -c ../etc/worddb.properties -e UTF-8 -m html -f ../web/spec/test/selec02.xml
...
<br />Output on 2012-05-15 08:02:25.715 by <a href="index.html">Dbat</a> script <a target="_blank" href="./../web/spec/test/selec02.xml.xml" type="text/plain">../web/spec/test/selec02.xml</a>,
