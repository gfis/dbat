xsltproc ../etc/xslt/dbiv_spec.xsl ../web/spec/test/crud05.iv.xml
...
<!--test.crud05.xml äöü
  ...
  DO NOT EDIT HERE, but in test.crud05.iv.xml instead!
-->
<dbat xmlns="http://www.teherba.org/2007/dbat" xmlns:ht="http://www.w3.org/1999/xhtml" xmlns:iv="http://www.teherba.org/2011/dbiv" xmlns:db="http://www.teherba.org/2007/dbat" encoding="UTF-8" conn="worddb" lang="en" title="test/crud05">
  <!--
...
<choose>
  ...
  <when name="view" match="del">
    <select limit="512">
      ...
      <where>(name like '<db:parm name="search_name"/>%') 
        and name = '<parm name="name"/>'
    ...
    <ht:form method="post">
      ...
      <ht:input type="submit" value="Delete"/> <ht:a href="servlet?spec=test.crud05">Back</ht:a> to the search form
    </ht:form>
  </when><!--== d e l 2 ==============-->
  ...
  <when name="view" match="dat">
    ...
    <ht:form name="form1" method="post">
      ...
      <ht:a href="servlet?spec=test.crud05">Back</ht:a> to the search form
    </ht:form>
  </when><!--== i n s ==============-->
  <when name="view" match="ins">
    ...
    <ht:form name="form1" method="post">
      ...
      <ht:input type="submit" value="Save"/> <ht:a href="servlet?spec=test.crud05">Back</ht:a> to the search form
    </ht:form>
  </when><!--== i n s 2 ==============-->
  ...
  <when name="view" match="upd">
    ...
    <ht:form name="form1" method="post">
      ...
      <ht:input type="submit" value="Update"/> <ht:a href="servlet?spec=test.crud05">Back</ht:a> to the search form
    </ht:form>
  </when><!--== u p d 2 ==============-->
...
<choose>
  <when name="view" match="(sear|ins2|upd2|del2|)">
    ...
    <select limit="2048">
      <col pseudo="image" label="Upd." align="center" remark="update" link="test.crud05&amp;search_name=&amp;search_decease=&amp;search_family=&amp;name=&amp;decease=&amp;family=&amp;view=">
      ...
      <col pseudo="image" label="Del." align="center" remark="delete" link="test.crud05&amp;search_name=&amp;search_decease=&amp;search_family=&amp;name=&amp;decease=&amp;family=&amp;view=">
        '<parm name="search_name"/>' || '=' 
         || '<parm name="search_decease"/>' || '=' 
         || '<parm name="search_family"/>' || '=' 
         || name || '=' 
      ...
      <col pseudo="image" label="Show" align="center" remark="details" link="test.crud05&amp;search_name=&amp;search_decease=&amp;search_family=&amp;name=&amp;decease=&amp;family=&amp;view=">
        '<parm name="search_name"/>' || '=' 
         || '<parm name="search_decease"/>' || '=' 
         || '<parm name="search_family"/>' || '=' 
         || name || '=' 
      ...
      <from>relatives r</from>
      <where>(name like '<db:parm name="search_name"/>%') 
        and name like '<parm name="search_name"/>%'
