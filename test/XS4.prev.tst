xsltproc ../etc/xslt/dbiv_spec.xsl ../web/spec/test/crud04.iv.xml
...
<!--test/crud04.xml äöü
  @(#) $Id$
  Generated by dbat/etc/xslt/dbiv_spec.xsl V1.3 at 2012-06-21T19:13:55+02:00
  DO NOT EDIT HERE, but in test/crud04.iv.xml instead!
-->
<dbat xmlns="http://www.teherba.org/2007/dbat" xmlns:ht="http://www.w3.org/1999/xhtml" xmlns:iv="http://www.teherba.org/2011/dbiv" xmlns:db="http://www.teherba.org/2007/dbat" encoding="UTF-8" conn="worddb" lang="en" javascript="http_request.js" title="test/crud04">
  <!--
...
<choose>
  ...
  <when name="view" match="del">
    ...
    <ht:form method="post">
      ...
      <ht:input name="search_family" type="hidden" init="Ritter"/>
      <ht:input name="name" type="hidden" init=""/>
      <ht:input name="decease" type="hidden" init=""/>
      <ht:input name="family" type="hidden" init="Ritter"/>
      <ht:input name="gender" type="hidden" init=""/>
      ...
      <ht:input type="submit" value="Delete"/> <ht:a href="servlet?spec=test/crud04">Back</ht:a> to the search form
    </ht:form>
  </when><!--== d e l 2 ==============-->
  ...
  <when name="view" match="dat">
    ...
    <ht:form name="form1" method="post">
      ...
      <ht:tr><ht:td id="pl0" class="wht">Place:</ht:td><ht:td id="pl1" class="wht"><ht:a href="servlet?spec=test.crud01&amp;name=M">Berlin</ht:a></ht:td></ht:tr>
      ...
      <ht:tr><ht:td valign="top" title="changed" class="wht">Changed:</ht:td>
        <ht:td class="wht"><parm name="changed"/>
        </ht:td></ht:tr>
      </ht:table>
      <ht:a href="servlet?spec=test/crud04">Back</ht:a> to the search form
    </ht:form>
  </when><!--== i n s ==============-->
  <when name="view" match="ins">
    ...
    <ht:form name="form1" method="post">
      ...
      <ht:tr><ht:td valign="top" title="family">Family:</ht:td>
        <ht:td><ht:select name="family" init="Ritter" size="2">
        <ht:option value="Ritter" selected="true">Ritter Family</ht:option>
      ...
      <ht:tr><ht:td valign="top" title="gender">Gender:</ht:td>
        ...
        <db:listbox height="2" name="gender" init="" code="code" display="display"/>
      ...
      <ht:input type="submit" value="Save"/> <ht:a href="servlet?spec=test/crud04">Back</ht:a> to the search form
    </ht:form>
  </when><!--== i n s 2 ==============-->
  ...
  <when name="view" match="upd">
    ...
    <ht:form name="form1" method="post">
      ...
      <ht:input type="submit" value="Update"/> <ht:a href="servlet?spec=test/crud04">Back</ht:a> to the search form
    </ht:form>
  </when><!--== u p d 2 ==============-->
...
<choose>
  <when name="view" match="(sear|ins2|upd2|del2|)">
    <ht:form method="post">
      ...
      <ht:tr><ht:td valign="top" title="family">Family:</ht:td>
        <ht:td><ht:select name="search_family" init="Ritter" size="3">
    ...
    <select limit="2048">
      ...
      <col pseudo="image" label="Del." align="center" remark="delete" link="test/crud04&amp;search_name=&amp;search_decease=&amp;search_family=&amp;name=&amp;decease=&amp;family=&amp;view=">
        '<parm name="search_name"/>' || '=' 
         || '<parm name="search_decease"/>' || '=' 
         || '<parm name="search_family"/>' || '=' 
         || name || '=' 
