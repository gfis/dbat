java -cp ../dist/dbat.jar org.teherba.dbat.Dbat -c ../etc/worddb.properties -e UTF-8 -f ../web/spec/test/color07.xml -p lang=de
...
<script src="./sorttable.js" type="text/javascript"></script>
    ...
    <form method="get" action="servlet?spec=../web/spec/test/color07.xml"><input name="spec" type="hidden" value="../web/spec/test/color07.xml" />
...
<br />Ausgabe am yyyy-mm-dd hh:mm:ss durch <a href="index.html">Dbat</a>-Skript <a target="_blank" href="./../web/spec/test/color07.xml" type="text/plain">../web/spec/test/color07.xml</a>,
<a target="_blank" href="servlet?&amp;mode=xls&amp;name=%25&amp;lang=de">Excel</a>,
<a href="servlet?&amp;view=more&amp;mode=html&amp;name=%25&amp;lang=de">mehr</a>
