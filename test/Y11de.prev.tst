...
<link rel="stylesheet" type="text/css" href="spec/test/stylesheet.css" />
    ...
    <h3 class="error">XML SAX parsing error: Der Content von Elementen muss aus ordnungsgemäß formatierten Zeichendaten oder Markups bestehen. in Dbat specification <em>test/badxml</em>, line 29, column 10, cause: null</h3></body></html>
