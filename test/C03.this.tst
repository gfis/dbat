java -cp ../dist/dbat.jar org.teherba.dbat.Dbat -c ../etc/worddb.properties -e UTF-8 -m html -f ../web/spec/test/color04.xml
...
<br />Output on 2012-06-01 22:56:39.172 by <a href="index.html">Dbat</a> script <a target="_blank" href="./../web/spec/test/color04.xml.xml" type="text/plain">../web/spec/test/color04.xml</a>,
