...
<choose>
	<when name="view" match="(sear|ins2|upd2|del2|)">
		...
		<select limit="2048">
			<col pseudo="image" label="Upd." align="center" link="test/crud03&amp;search_crit_1=&amp;search_crit_2=&amp;search_crit_3=&amp;name=&amp;family=&amp;gender=&amp;view=">
			...
			<col pseudo="image" label="Del." align="center" link="test/crud03&amp;search_crit_1=&amp;search_crit_2=&amp;search_crit_3=&amp;name=&amp;family=&amp;gender=&amp;view=">
				'<parm name="search_crit_1"/>' || '=' 
				 || '<parm name="search_crit_2"/>' || '=' 
				 || '<parm name="search_crit_3"/>' || '=' 
				 || name || '=' 
