wget -q -O - "http://localhost:8080/dbat/servlet?spec=test/stylesheet1"
...
<link rel="stylesheet" type="text/css" href="web/stylesheet.css" />
	...
	<!--Explicit Stylesheet-->
	<!--Explizite Stylesheet-Angabe-->

    <h3>Explicit Stylesheet</h3>
...
<br />Output on yyyy-mm-dd hh:mm:ss by <a href="index.html">Dbat</a> script <a target="_blank" href="spec/test/stylesheet1.xml" type="text/plain">test/stylesheet1</a>,
<a target="_blank" href="servlet?&amp;mode=xls&amp;spec=test%2Fstylesheet1&amp;name=%25r&amp;lang=en">Excel</a>,
<a href="servlet?&amp;view=more&amp;mode=html&amp;spec=test%2Fstylesheet1&amp;name=%25r&amp;lang=en">more</a>
