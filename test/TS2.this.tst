java -cp ../dist/dbat.jar org.teherba.dbat.Dbat -c ../etc/worddb.properties -e UTF-8 -m html -f ../web/spec/test/xslt_brackets.xml
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd" [
]>
<?xml-stylesheet type="text/xsl" href="./test/brackets.xsl" ?>
...
<br />Output on 2012-06-01 22:56:53.328 by <a href="index.html">Dbat</a> script <a target="_blank" href="./../web/spec/test/xslt_brackets.xml.xml" type="text/plain">../web/spec/test/xslt_brackets.xml</a>,
