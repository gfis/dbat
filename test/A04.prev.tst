...
<link rel="stylesheet" type="text/css" href="spec/test/stylesheet.css" />
    ...
    <form method="get" action="servlet?spec=test/parmlink"><input name="spec" type="hidden" value="test/parmlink" />
        ...
        Name: <input name="name" maxsize="20" size="10" init="M" value="F"></input>%   
...
<a target="_blank" href="servlet?&amp;mode=xlsx&amp;name=F&amp;spec=test%2Fparmlink&amp;year=2013&amp;lang=en">Excel</a>,
<a href="servlet?&amp;view=more&amp;mode=html&amp;name=F&amp;spec=test%2Fparmlink&amp;year=2013&amp;lang=en">more</a>
